...
app.get('/books', function(req, res){
  ...
  bookNum.forEach(function(num){
     books.push(bookObj[num])
  });

  res.render ("index.ejs", {bookObj: books});
...
app.get('/book/:id', function(req, res){
  bookNum = parseInt(req.params.id);

  res.render('show.ejs', {bookObj: bookObj[bookNum]});
...
app.put('/book/:id', function(req, res){
  ...
  bookObj[bookNum] = {
    ...
    isbn13: req.body.newISBN,
    description: req.body.newDescrip
  }

  res.redirect('/book/'+bookNum);
